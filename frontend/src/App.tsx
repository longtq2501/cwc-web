    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <button className="text-primary font-medium hover:bg-primary-pale px-4 py-2 rounded-full transition-colors">
            Đăng nhập
          </button>
          <button className="bg-primary-mid text-white font-medium px-6 py-2 rounded-full hover:bg-primary transition-colors flex items-center gap-2">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-white shadow-lg py-4 px-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 mt-2">
            <button className="text-primary font-medium py-2 border border-primary rounded-full">Đăng nhập</button>
            <button className="bg-primary-mid text-white font-medium py-2 rounded-full">Bắt đầu miễn phí</button>
          </div>
        </div>
      )}
    </nav>
        ...
        <div className="relative aspect-square bg-primary-pale rounded-full flex items-center justify-center p-8">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <div className="w-2 h-2 bg-status-collected rounded-full animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-card hover:shadow-hover transition-all border-t-4 border-enterprise">
            ...
            <button className="text-enterprise font-bold flex items-center gap-2 hover:gap-3 transition-all">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          <div className="grid lg:grid-cols-2">
            <div className="p-10 lg:p-16 bg-enterprise text-white">
              ...
              <button className="bg-white text-enterprise font-bold px-8 py-4 rounded-full hover:bg-gray-100 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-primary-pale/30 p-8 rounded-3xl border border-primary-pale">
            ...
            <form className="space-y-4">
              ...
              <select className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary text-gray-600">
                <option value="">Chọn Phường/Xã</option>
                <option value="p7">Phường 7, Q.Bình Thạnh</option>
                <option value="p3">Phường 3, Q.Tân Bình</option>
              </select>
              <button type="button" className="w-full bg-primary-mid text-white font-bold py-4 rounded-xl hover:bg-primary transition-colors flex items-center justify-center gap-2 mt-4">
          ...
          <div className="bg-enterprise-lt/10 p-8 rounded-3xl border border-enterprise-lt/30">
            ...
            <form className="space-y-4">
              ...
              <select className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:border-enterprise focus:ring-1 focus:ring-enterprise text-gray-600">
                <option value="">Chọn Tỉnh/Thành phố</option>
                <option value="hcm">TP. Hồ Chí Minh</option>
                <option value="hn">Hà Nội</option>
              </select>
              <button type="button" className="w-full bg-enterprise text-white font-bold py-4 rounded-xl hover:bg-enterprise/90 transition-colors flex items-center justify-center gap-2 mt-4">
